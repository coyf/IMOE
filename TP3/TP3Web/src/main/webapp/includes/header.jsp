    ...
    <tr valign="top">
        <td>
            ...
            <table width="764" height="97" cellpadding="0" cellspacing="0" border="0">
                <tr valign="top">
                    <td width="248">
                        <img src="img/logo.jpg" width="248" height="97" border="0" alt="">
                    </td>
                    <td width="100%" background="img/toplogobg.jpg">
                        <img src="img/toplogobg.jpg" width="22" height="97" border="0" alt="">
                    </td>
                </tr>
            </table>
            ...
            <table width="764" height="42" cellpadding="0" cellspacing="0" border="0">
                <tr valign="top">
                    ...
                    <td width="100%" background="img/left1bg.jpg">
                        <img src="img/left1bg.jpg" width="20" height="42" border="0" alt="">
                    </td>
                </tr>
            </table>
